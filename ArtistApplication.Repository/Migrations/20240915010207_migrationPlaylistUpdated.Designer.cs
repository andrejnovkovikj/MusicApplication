...
namespace ArtistApplication.Repository.Migrations
{
    ...
    [Migration("20240915010207_migrationPlaylistUpdated")]
    partial class migrationPlaylistUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtistApplication.Domain.Identity.ArtistApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ArtistApplication.Domain.Identity.ArtistApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
